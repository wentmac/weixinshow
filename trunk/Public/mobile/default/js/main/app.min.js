/*!webAddr:http://www.fynut.com, author:eric_wu, email:478857585@qq.com, version:v-2015-06-12:306 */
var Zepto = function() {
    function a(a) {
...
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto),
    ...
    function(a) {
        ...
        z.href = window.location.href, a.active = 0, a.ajaxJSONP = function(b, c) {
            ...
            if (n && n.promise(A), i.crossDomain || w("X-Requested-With", "XMLHttpRequest"), w("Accept", u || "*/*"), (u = i.mimeType || u) && (u.indexOf(",") > -1 && (u = u.split(",", 2)[0]), A.overrideMimeType && A.overrideMimeType(u)), (i.contentType || i.contentType !== !1 && i.data && "GET" != i.type.toUpperCase()) && w("Content-Type", i.contentType || "application/x-www-form-urlencoded"), i.headers)
                for (q in i.headers) w(q, i.headers[q]);
            ...
            if (i.xhrFields)
                for (q in i.xhrFields) A[q] = i.xhrFields[q];
    ...
    function() {
        function a(a, b) {
            if (this.el = "string" == typeof a ? document.querySelector(a) : a, this.slides = this.el.querySelectorAll("li"), this.isVertical = "vertical" == b.dir ? !0 : !1, this.cur = b.cur, this.initSuccess = b.initSuccess || function() {}, this.success = b.success || function() {}, this.preventLoop = b.preventLoop, !(this.slides.length < 2)) {
        ...
        var b = {
            ...
            c = window.Modernizr && Modernizr.touch === !0 || function() {
        ...
        a.prototype = {
            init: function() {
                $(this.slides[this.cur]).addClass("cur"), b.addEvent(this.el, d.start, this), this.initSuccess.call(this.el)
            },
            start: function(a) {
                if ("A" != a.target.tagName) {
                    if (this.moving) return a.preventDefault(), !1;
                    var e = c ? a.touches[0] : a;
                    this.data = {
                        startX: e.pageX,
                        startY: e.pageY,
                        distX: 0,
                        distY: 0,
                        time: +new Date
                    }, b.addEvent(this.el, d.move, this), b.addEvent(this.el, d.end, this)
                }
            },
            move: function(a) {
                var d = c ? a.touches[0] : a,
                    e = this.data;
                e.distX = d.pageX - e.startX, e.distY = d.pageY - e.startY, this.translate(this.isVertical ? e.distY : e.distX, this.isVertical ? b.winH : b.winW), a.preventDefault()
            },
            end: function(a) {
                this.isReverseDir || this.animate(), b.removeEvent(this.el, d.move, this), b.removeEvent(this.el, d.end, this)
            },
            reset: function() {
                console.log("reset")
            },
            animate: function() {
                var a = this,
                    c = this.data,
                    d = +new Date - c.time;
                curObj = $(this.slides[this.cur]), nextObj = $(this.nextSlide), isRevert = 50 > d || Math.abs(this.getDisValue(c.distX, c.distY)) < 60, $(this.nextSlide).addClass("animated"), curObj.addClass("animated"), this.isVertical ? this.translate((c.distY > 0 ? 1 : -1) * b.winH, b.winH, isRevert) : this.translate((c.distX > 0 ? 1 : -1) * b.winW, b.winW, isRevert), this.moving = !0, setTimeout(function() {
                    a.moving = !1, (isRevert ? curObj : nextObj).removeAttr("style").attr("class", "cur").siblings().removeAttr("style").removeAttr("class"), isRevert || (a.cur = a.nextIndex, a.success.call(a))
                }, 300)
            },
            getDisValue: function(a, b) {
                return this.isVertical ? b : a
            },
        ...
        }, window.Swipe = a, $.fn.swipe = function(b) {
            var c = {
                cur: 0,
                dir: "vertical"
            };
            return this.each(function() {
                return $(this).data("swipe", new a(this, $.extend(c, b))), this
            })
        }
    }();
var imgLoad = function() {
    return function(a, b, c) {
        var d = new Image;
        return d.src = a, d.complete ? void b.call(d) : (d.onload = function() {
            b.call(this), d = d.onload = d.onerror = null
        }, void(d.onerror = c || function() {}))
    }
}();
$(function() {
    function a(a) {
        var b = a.css("background-image");
        return b ? b.replace(/^url\(|\)$/g, "") : ""
    }

    function b() {
        $("#swipe li").each(function(b) {
            if (b != config.swipeCur) {
                var c = a($(this).find("div").eq(0)),
                    d = new Image,
                    e = this;
                d.src = c, "blur" == $(this).data("role") && (d.onload = function() {
                    $(e).stackBlur({
                        img: d,
                        radius: 10,
                        callback: function() {
    ...
    function c() {
        config.coverUrl ? imgLoad(config.coverUrl, function() {
            $("#lottery").lottery({
                ...
                callback: function(a) {
                    a > 50 && !h && (h = !0, $(this).parent().removeClass("show").on("webkitTransitionEnd", function() {
                        e(), $(this).hide()
                    }))
                },
                success: function() {
                    setTimeout(b, 500), $(this.conNode).addClass("show").on("webkitTransitionEnd", function() {
    ...
    var r = "ontouchstart" in window,
        ...
        t = r ? "touchend" : "mouseup";
    if ($(".download_link").tap(function() {
            ga("send", "event", "下载", "click", "3g"), location.href = n
        }).on(s, function() {
            $(this).addClass("down")
        }).on(t, function() {
        ...
        for (var w in v) v.hasOwnProperty(w) && w in u && (u[w] = v[w]);
        u.play(), $(document).one("touchstart", function(a) {
            u.paused && u.play()
        })
    }
    var x = $("body").height(),
        y = $(window).height();
    x != y && window.scrollTo(0, x - y)
});
