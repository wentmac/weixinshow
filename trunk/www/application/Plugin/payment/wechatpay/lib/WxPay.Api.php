...
class WxPayApi
{
	...
	public static function report($inputObj, $timeOut = 1)
	{
		...
		$inputObj->SetSign();//签名
		$xml = $inputObj->ToXml();		
        Log::getInstance( 'mobile_order_payment_wechatpay_error' )->write( 'wechatpay_report:' . $xml );
	...
	{		
        Log::getInstance( 'mobile_order_payment_wechatpay_error' )->write( 'wechatpay_replyNotify:' . $xml );
		echo $xml;
	}
