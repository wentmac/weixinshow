<?php
$config['config']['cfg_webname'] = '银品惠';
$config['config']['cfg_nameinfo'] = '博客程序';
$config['config']['cfg_keywords'] = 'rugby互联网,SNS,交互设计,界面设计,可用性设计,产品设计,用户体验,HTML,网页结构,WEB标准';
$config['config']['cfg_description'] = 'rugby专注于互联网潮流，可用性分析，以用户为中心的设计，软件设计，网页设计等的专业博客';
$config['config']['cfg_style'] = 'default';
$config['config']['cfg_indexurl'] = 'http://test.yph.weixinshow.com/';
