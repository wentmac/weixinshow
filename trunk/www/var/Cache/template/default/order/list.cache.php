...
0
|| self::check('default\order/list.tpl', 'D:\Web\Work\www.090.cn\trunk\admin\application\View\default\order\list.tpl', 1455983996)
;?>
...
订单类型 : 
    <select name="demo_order" id="demo_order">
	<option value="0">|-全部</option>
    <?php echo $demo_order_option;?>
    </select>		

	用户UID：<input type="text" name="uid" value="<?php echo $uid;?>">　    

  商城：<input type="text" name="domain" value="<?php echo $domain;?>" placeholder="输入商城域名">　    
	　
