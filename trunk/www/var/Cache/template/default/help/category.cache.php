...
0
|| self::check('default\help/category.tpl', 'D:\Web\Work\www.090.cn\trunk\admin\application\View\default\help\category.tpl', 1448078387)
;?>
...
<?php if($action == 'add' ) { ?>    
    <form method="post" action="<?php echo PHP_SELF; ?>?m=help/category.save" onSubmit="return checkForm(this);">
    <input type="hidden" value="<?php echo $editinfo->help_cat_id;?>" name="help_cat_id" id="help_cat_id">
    ...
    <tbody>
		...
		<tr>
        	<td class="td_right">分类类型</td>
			<td class="td_left">
            <select name="cat_type" id="cat_type">    			
				<?php echo $cat_type_option;?>
		    </select>
            </td>
            <td class="td_left hui"></td>
        </tr>   		
    ...
    <table width="100%" cellspacing="1" cellpadding="2" align="center" class="t_list">
        <tbody>
            <tr>
                ...
                <th width="20%"><strong>分类cat_id</strong></th>                
