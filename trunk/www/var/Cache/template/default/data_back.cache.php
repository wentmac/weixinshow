...
0
|| self::check('default\data_back.tpl', 'D:\Web\Work\www.090.cn\trunk\admin\application\View\default\data_back.tpl', 1433408041)
;?>
...
<table width="99%" border="0" cellpadding="3" cellspacing="1" bgcolor="#D1DDAA">
    ...
    <td height="19" colspan="6" background="img/tbg.gif" bgcolor="#E7E7E7">
        ...
        <tr>
          ...
          <td width="76%" align="right">
          	<b><a href="<?php echo PHP_SELF; ?>?m=data.revert"><u>数据还原</u></a></b>
          </td>
        </tr>
      </table>
    </td>
  </tr>
  <form name="form1" onSubmit="checkSubmit()" action="<?php echo PHP_SELF; ?>?m=data.dobak" method="post" target="stafrm">
  <input type='hidden' name='tablearr' value='' />
  <tr bgcolor="#F7F8ED">
    <td height="24" colspan="6"><strong><?php echo $dname;?>数据库 默认数据表：</strong></td>
  </tr>
  ...
  <?php for($i=0; isset($tableAry[$i]); $i++)
  {
    $t = $tableAry[$i]['tname'];
