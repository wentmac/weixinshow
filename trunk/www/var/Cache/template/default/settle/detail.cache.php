...
0
|| self::check('default\settle/detail.tpl', 'D:\Web\Work\www.090.cn\trunk\admin\application\View\default\settle\detail.tpl', 1446551647)
;?>
...
<form name="forms" id="forms" action="<?php echo PHP_SELF; ?>?m=settle.save" method="post" >
    <table width="100%" cellspacing="0" cellpadding="0" border="0" class="t_list">
      ...
      <tr>
        <td class="td_right_f00" width="150">申请提现用户：</td>
	  ...
	  <tr>
		...
		<?php if($editinfo->account_type==1) { ?>
		<tr>
          <td class="td_right">开户行</td>
          <td class="td_left"><?php echo $editinfo->bank_name;?></td>
		</tr>		
		<tr>
          <td class="td_right">收款人姓名</td>
          <td class="td_left"><?php echo $editinfo->bank_account;?></td>
		</tr>		
		<tr>
          <td class="td_right">银行卡账号</td>
          <td class="td_left"><?php echo $editinfo->bank_cardnum;?></td>
		</tr>			
		<?php } else { ?>
		<tr>
          <td class="td_right">支付宝账号</td>
          <td class="td_left"><?php echo $editinfo->alipay_account;?></td>
		</tr>		
		<tr>
          <td class="td_right">支付宝真实姓名</td>
          <td class="td_left"><?php echo $editinfo->alipay_username;?></td>
		</tr>		
		<?php } ?>
