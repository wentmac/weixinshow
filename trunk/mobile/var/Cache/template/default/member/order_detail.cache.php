...
0
|| self::check('default\member/order_detail.tpl', 'D:\Web\Witkey\wwwroot\yph\trunk\mobile\application\View\default\member\order_detail.tpl', 1464413820)
;?>
<html>
...
<body>
  ...
  <header id="kd_status" class="kd_tle kd_status">
    <span class="leixing">订单类型：<em><?php echo $order_info->order_status_text;?></em></span>
    <span class="order"><i>商品总额：</i><em>￥<?php echo $order_info->order_payable_amount;?></em></span>
    <?php if(!empty($order_info->order_integral_amount)) { ?>
    <span class="order"><i>积分抵扣：</i><em>-￥<?php echo $order_info->order_integral_amount;?></em></span>
    <?php } ?>
    <span class="order"><i>应付总额：</i><em>￥<?php echo $order_info->order_amount;?></em></span>
  </header>
