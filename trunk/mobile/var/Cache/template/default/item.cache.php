...
0
|| self::check('default\item.tpl', 'D:\Web\Witkey\wwwroot\yph\trunk\mobile\application\View\default\item.tpl', 1458884973)
;?>
<!DOCTYPE html>
<html>
	...
	<head>
		...
		<title><?php echo $item_info->item_name;?></title>
	...
	<body style="padding-bottom: 60px;">
		<div id="item_show_wrap" style="height: auto; overflow: visible;">
			<header id="common_hd" class="c_txt rel hide" style="display: block;"><a id="hd_back" class="abs" href="<?php echo $referer_url;?>">返回</a>
				<a id="common_hd_logo" class="hd_logo t_hide abs"><?php echo $config['cfg_webname'];?></a>
			...
			<div id="item_info_for_show_wrap" class="hide" style="display: block;">
				...
				<section id="item_info" class="rel">
					...
					<article id="item_show" class="loading c_txt rel">
						<!--<img width="100%" src="<?php echo $item_info->goods_image_id;?>" data-share-src="<?php echo $item_info->goods_image_id;?>">-->
						<div id="hd_bg_item" class="abs hide" style="display: block;"></div><em id="sold" class="abs">收藏&nbsp;<span id="collect-number"><?php echo $item_info->collect_count;?></span></em>
						<div id="favorite" class="favorite for_gaq hide" data-for-gaq="收藏商品">收藏</div>
					</article>
					<h2 id="item_name"><strong><?php echo $item_info->item_name;?></strong><br>
        
        </h2>
					<div id="item_price_wrap" class="rel">
						<p><span id="seckill_price" class="hide"></span> <span id="item_price" class="i_pri"><?php echo $item_info->item_price;?></span> <span id="seckill_discount"></span></p>
						...
						<!-- <?php if(empty($item_info->shipping_fee)) { ?>-->
						...
						<!-- <?php } else { ?> -->
						<p id="free_delivery" class="hide rel" style="display: block;">邮费:<em id="free_delivery_em">￥<?php echo $item_info->shipping_fee;?></em></p>
				...
				<section id="item_seller">
					<a id="seller_wrap" class="rel hide for_gaq" data-for-gaq="进入店铺" href="/shop/<?php echo $item_info->uid;?>" style="display: block;">
						<div id="seller_thumb_wrap" class="abs"><img width="100%" id="seller_thumb" class="abs" src="<?php echo $shop_info->shop_image_url;?>"></div>
						<p id="seller_name" class="over_hidden ellipsis"><?php echo $shop_info->shop_name;?></p>						
					</a>
					<div id="seller_entry_wrap">
						<a id="enter_shop_class" class="left for_gaq c_txt" data-for-gaq="查看商品分类" href="/shop/search?id=<?php echo $item_info->uid;?>"><em>&nbsp;</em>查看商品分类</a>
						<a id="enter_shop" href="/shop/<?php echo $item_info->uid;?>" class="right for_gaq c_txt" data-for-gaq="进入店铺"><em>&nbsp;</em>进入店铺</a></div>
				</section>
				<section id="item_detail">
					<div id="detail_wrap">
						<div id="video_wrap" class="hide">&nbsp;</div>
						
						<?php if($item_photo_show) { ?>
						<?php if(is_array($goods_image_array)) foreach($goods_image_array AS $k => $v) { ?>
						<img src="<?php echo $v->goods_image_id;?>" width="100%">
						<?php } ?>
						<?php } ?>
						<?php echo $item_info->item_desc;?>
					</div>
			...
			<footer id="item_fix_btn" class="fix hide wrap" style="-webkit-transition: opacity 200ms ease; transition: opacity 200ms ease; opacity: 1; display: block;">
				<div class="contact_div">
					<ul>
						<li><a href="tel:<?php echo $shop_info->mobile;?>">拨打电话</a></li>
						<li style=" height: 2px; line-height: 2px;">
							<hr>
						</li>
						<li><a href="sms:<?php echo $shop_info->mobile;?>">发送短信</a></li>
					</ul>
				</div>
				...
				<div class="am-modal-bd am-text-left">
					<div class="select_sku_pro_info">
						<div class="sku_img am-fl">
							<img src="<?php echo $item_info->goods_image_id;?>" width="50" height="50">
						</div>
						<div id="sku_pro_tit" class="sku_pro_tit"><?php echo $item_info->item_name;?></div>
					...
					无含邮费
					<!-- <?php } else { ?> -->
					<div id="shipping_fee" class="left sku_item_tit am-padding-left-sm">邮费:</div>￥<?php echo $item_info->shipping_fee;?>
					<?php } ?>
					<hr>
		...
		<script type="text/javascript">
			...
			var gloabl_item_id = <?php echo $item_info->item_id;?>;
			var gloabl_item_price = '<?php echo $item_info->item_price;?>';
			var gloabl_item_stock = <?php echo $item_info->item_stock;?>;
			var global_goods_name = '<?php echo $item_info->item_name;?>';
		...
		<script src="<?php echo $BASE_V;?>js/item.js?v=20151229" type="text/javascript"></script>
	</body>
