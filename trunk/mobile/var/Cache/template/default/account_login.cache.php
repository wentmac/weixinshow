...
0
|| self::check('default\account_login.tpl', 'D:\Web\Witkey\wwwroot\yph\trunk\mobile\application\View\default\account_login.tpl', 1464592547)
;?>
﻿<!DOCTYPE html>
<html>
...
<body>
    <header id="common_hd" class="c_txt rel"><a id="hd_back" class="abs comm_p8 hide" href="<?php echo $referer_url;?>" style="display: block;">返回</a>
    ...
    var referer_url = '<?php echo $referer_login;?>';
    var global_mobile = $.cookie('mobile');
    </script>
    <script src="<?php echo $BASE_V;?>js/account_login.js?v=1" type="text/javascript"></script>
</body>
