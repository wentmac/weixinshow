...
0
|| self::check('default\order_address_add.tpl', 'D:\Web\Witkey\wwwroot\yph\trunk\mobile\application\View\default\order_address_add.tpl', 1464493624)
;?>
<!DOCTYPE html>
<html>
...
<head>
  ...
  <link href="<?php echo $BASE_V;?>css/cart/myaddress.css" type="text/css" rel="stylesheet">
...
<body>
  <header id="common_hd" class="c_txt rel"><a id="hd_back" class="abs comm_p8" href="<?php echo $referer_url;?>">返回</a> <a id="common_hd_logo" class="t_hide abs"><?php echo $config['cfg_webname'];?></a>
  ...
  <script src="<?php echo $BASE_V;?>js/order_address.js" type="text/javascript"></script>
</body>
