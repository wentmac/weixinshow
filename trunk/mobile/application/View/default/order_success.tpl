...
<body>
  <h1 class="successTxt">支付成功！</h1>
  <p class="back_Btn"><span class="left"><a class="btncancel for_gaq" data-for-gaq="返回购物车" href="/order/cart">返回购物车</a></span><span class="right"><a class="btnok for_gaq" data-for-gaq="返回店铺" id="backShop" href="/shop/{$order_info->item_uid}">返回店铺</a></span></p>
  ...
  <!--<div class="erweima"><img src="http://s.koudai.com/images/others/pay_result/erweima.jpg" id="erweima"></div>
  <div id="erweimaTxt">
