...
<body style="margin: 0 auto; max-width: 640px">
  <div data-role="container" class="body userCenter">
    ...
    <section data-role="body" class="section-body">
      ...
      <div>
        <ul class="list">
          <li><a href="{MOBILE_URL}member/order"><i class="icon-order"></i>全部订单</a></li>
      ...
      <div>
        <ul class="list">  
          ...
          <li><a href="{MOBILE_URL}member/agent.level"><i class="icon-level"></i>排位</a></li>
