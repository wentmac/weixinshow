...
$config[ 'alipay_config' ][ 'partner' ] = '20**********91';

//安全检验码，以数字和字母组成的32位字符
//如果签名方式设置为“MD5”时，请设置该参数
$config[ 'alipay_config' ][ 'key' ] = 'duwc******************ryg';
...
$config[ 'alipay_config' ][ 'return_url' ] = MOBILE_URL . 'pay/alipay.returnurl';

//服务器异步通知页面路径，要用 http://格式的完整路径，不允许加?id=123这类自定义参数
$config[ 'alipay_config' ][ 'notify_url' ] = MOBILE_URL . 'pay/alipay.notify';

//操作中断返回地址
$config[ 'alipay_config' ][ 'merchant_url' ] = MOBILE_URL . 'pay/alipay.merchant';
//↑↑↑↑↑↑↑↑↑↑请在这里配置您的基本信息↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑
...
$config[ 'alipay_config' ][ 'cacert' ] = TMAC_BASE_PATH . APP_MOBILE_NAME . DIRECTORY_SEPARATOR . APPLICATION . '/Plugin/payment/alipay/cacert.pem';
?>