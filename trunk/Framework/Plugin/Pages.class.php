 ...
 * $Id: Pages.class.php 325 2016-05-31 10:07:35Z zhangwentao $
 * http://www.t-mac.org；
 */
...
class Pages
{
     ...
     */
    private $param;
    private $suffix = ''; //url后缀，比如伪静态后的反斜线
     ...
     *
     */
    public function setUrl($url, $suffix='')
    {
//        unset($_GET['page']);
        $this->param = $url;
        $this->suffix = $suffix;
    ...
    {
        return $this->param . $page . $this->suffix;
    }
