...
<table width="100%" cellspacing="0" cellpadding="0" border="0" class="t_list">
   <tr>   
    ...
    $settle_status_option
		...
		　
	关键词：<input type="text" name="query_string" value="{$query_string}" placeholder='输入：用户id/手机号/用户名 搜索' size=30>　
...
<form name="list_form" method="POST" action="{PHP_SELF}?m=settle.index&page={$pageCurrent}" onSubmit="return checkDelForm();">
    <table width="100%" cellspacing="0" cellpadding="0" border="0" class="t_list">
      <tbody><tr>
      <th>&nbsp;</th>
        <th width="5%">编号</th>
