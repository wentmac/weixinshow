...
<!--{if $action == 'add' }-->    
    <form method="post" action="{PHP_SELF}?m=help/category.save" onSubmit="return checkForm(this);">
    <input type="hidden" value="{$editinfo->help_cat_id}" name="help_cat_id" id="help_cat_id">
