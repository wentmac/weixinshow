...
0
|| self::check('default\goods/index.tpl', 'D:\Web\Witkey\wwwroot\yph\trunk\admin\application\View\default\goods\index.tpl', 1464665692)
;?>
    ...
    <table width="100%" cellspacing="0" cellpadding="0" border="0" class="t_list">
      ...
      <td>
		<div class="cate" style="line-height: 22px;">
			<?php if(is_array($v->goods_cat_id)) foreach($v->goods_cat_id AS $goods_cat_id) { $cat_name = empty($goods_category_array[$goods_cat_id]) ? '' : $goods_category_array[$goods_cat_id]; ?><div class="cate-box" title="<?php echo $cat_name;?>"><?php echo $cat_name;?></div>
			<?php } ?>
		</div>	  	  
