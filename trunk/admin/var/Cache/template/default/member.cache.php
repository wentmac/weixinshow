...
0
|| self::check('default\member.tpl', 'D:\Web\Witkey\wwwroot\yph\trunk\admin\application\View\default\member.tpl', 1458292794)
;?>
...
<form name="list_form" method="POST" action="<?php echo PHP_SELF; ?>?m=member.batch_do&page=<?php echo $pageCurrent;?>" onSubmit="return checkDelForm();">
    <table width="100%" cellspacing="0" cellpadding="0" border="0" class="t_list">
      ...
      <td><?php echo $v->member_class_text;?>|<?php echo $v->member_level;?></td> 
      ...
      <td><a href="<?php echo PHP_SELF; ?>?m=member.level&uid=<?php echo $v->uid;?>">层级排位</a> | <a href="<?php echo PHP_SELF; ?>?m=member.detail&uid=<?php echo $v->uid;?>">详细</a></td>
      </tr>
      <?php } ?>      
