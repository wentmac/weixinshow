...
0
|| self::check('default\settle/index.tpl', 'D:\Web\Witkey\wwwroot\yph\trunk\admin\application\View\default\settle\index.tpl', 1459174296)
;?>
...
<form name="list_form" method="POST" action="<?php echo PHP_SELF; ?>?m=settle.index&page=<?php echo $pageCurrent;?>" onSubmit="return checkDelForm();">
    <table width="100%" cellspacing="0" cellpadding="0" border="0" class="t_list">
      ...
      <td><a href="<?php echo PHP_SELF; ?>?m=settle.member_bill_list&uid=<?php echo $v->uid;?>"><?php echo $v->uid;?></a></td>            
      <td><a href="<?php echo PHP_SELF; ?>?m=settle.member_bill_list&uid=<?php echo $v->uid;?>"><?php echo $v->realname;?></a></td>            
