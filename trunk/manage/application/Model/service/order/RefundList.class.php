 ...
 * http://www.t-mac.org；
 */
class service_order_RefundList_manage extends service_order_RefundList_base
{
    ...
    public function getSellerOrderRefundList()
    {
        ...
        if ( $count > 0 ) {
            ...
            $order_refund_dao->setField( 'order_refund_id,order_id,order_sn,order_goods_id,order_goods_detail,item_uid,shop_name,refund_service_status,money,service_status,refund_status,return_status,consignee,goods_uid,supplier_mobile,commission_fee,uid' );
            ...
            foreach ( $res as $value ) {
                ...
                $value->supplier_mobile = '02750243596';
        ...
        $return = array(
            'retHeader' => $retHeader,
            'retcode' => 'seller_order_refund_list',
            'retmsg' => $retmsg,
