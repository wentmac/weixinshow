...
0
|| self::check('default\account_login.tpl', 'D:\Web\Witkey\wwwroot\yph\trunk\manage\application\View\default\account_login.tpl', 1464859213)
;?>
<!DOCTYPE html>
<html>
...
<head lang="en">
  ...
  <link rel="stylesheet" href="<?php echo STATIC_URL; ?>common/assets/css/amazeui.min.css" />
  <style>
  .header {
    text-align: center;
  }
  ...
  <div style="width:330px; margin:0 auto">
      ...
      <div class="am-form-group">
        ...
        <div class="am-cf">
          ...
          <a class="am-btn am-btn-default am-radius am-btn-sm am-fr" href="<?php echo MOBILE_URL; echo PHP_SELF; ?>?m=account.forget">忘记密码 ^_^?</a>
        </div>
      </form>
      <hr>
      <p>还没有注册？<a href="<?php echo MOBILE_URL; echo PHP_SELF; ?>?m=account.register">马上注册></a></p>
  </div>
  <footer>
    <hr>
