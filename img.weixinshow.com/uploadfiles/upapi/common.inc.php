 ...
 */
error_reporting(0);
define('CFG_ROOT', dirname(dirname(__FILE__)) . DIRECTORY_SEPARATOR); //图片上传保存的根目录 “\Public\uploadfiles\”
define('STATIC_ROOT', substr(dirname(__FILE__), 0, -17)); //图片上传保存的根目录 “\Public\”
include STATIC_ROOT . 'images.config.php';
define('CFG_PICURL', CFG_INDEX_URL . 'uploadfiles/');
